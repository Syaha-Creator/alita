...
class ActionButtonBar extends StatelessWidget {
  ...
  const ActionButtonBar({
    ...
    this.primaryBackgroundColor = AppColors.primary,
    this.primaryForegroundColor = AppColors.surface,
    this.secondaryBorderColor = AppColors.border,
    this.secondaryForegroundColor = AppColors.textPrimary,
