...
load_dart_defines() {
  local keys="API_BASE_URL CLIENT_ID_ANDROID CLIENT_SECRET_ANDROID CLIENT_ID_IOS CLIENT_SECRET_IOS COMFORTA_ACCESS_TOKEN COMFORTA_CLIENT_ID COMFORTA_CLIENT_SECRET SPRINGAIR_ACCESS_TOKEN SPRINGAIR_CLIENT_ID SPRINGAIR_CLIENT_SECRET THERAPEDIC_ACCESS_TOKEN THERAPEDIC_CLIENT_ID THERAPEDIC_CLIENT_SECRET"
  DART_DEFINES=()
  for k in $keys; do
    local v
    v=$(read_env "$k")
